...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/_scripts.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _animate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animate */ "./assets/js/animate.js");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./events */ "./assets/js/events.js");
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./form */ "./assets/js/form.js");
...
_config__WEBPACK_IMPORTED_MODULE_1__["default"].events = {
  subscribe: function subscribe(type, el, ev) {
    el.addEventListener(type, ev, true);
    _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events = _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events || [];
    if (!_config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events.find(function (elev) {
      return elev.el === el;
    })) _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events.push({
      el: el,
      events: []
    });
    var elEvents = _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events.find(function (elev) {
      return elev.el === el;
    });
    elEvents.events.push({
      type: type,
      event: ev
    });
  },
  unsubscribe: function unsubscribe(type, el, ev) {
    _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events = _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events || [];
    var elEvents = _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events.find(function (elev) {
      return elev.el === el;
    });
    var elEvent = elEvents.events.find(function (event) {
      return event.type === type;
    });
    el.removeEventListener(type, elEvent.event, true);
    elEvents = elEvents.events.filter(function (event) {
      return event.type !== type;
    });

    for (var i in _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events) {
      if (_config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events[i].el === el) {
        _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events[i].events = elEvents;

        if (_config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events[i].events.length === 0) {
          _config__WEBPACK_IMPORTED_MODULE_1__["default"].state.events.splice(i, 1);
        }
...
_config__WEBPACK_IMPORTED_MODULE_1__["default"].request = {
  get: function get() {
...
(function () {
  Object(_events__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_form__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_animate__WEBPACK_IMPORTED_MODULE_2__["default"])();
  window.addEventListener('scroll', _animate__WEBPACK_IMPORTED_MODULE_2__["default"]);
})();
...
var eventListeners = function eventListeners() {
  ...
  if (document.getElementById('map')) {
    var location = {
      lat: 54.59690937624456,
      lng: -5.93963706715575
    };
...
var form = function form() {
  ...
  var validateForm = function validateForm(form) {
    ...
    var valItems = document.querySelectorAll('[data-required="true"]'),
        formValid = true;
  ...
  if (document.getElementById('yourDetailsForm')) {
    ...
    detailsForm.addEventListener('click', function (e) {
      ...
      if (validateForm(form)) {
        var userDetails = formToJSON(yourDetailsForm.elements);
        alert("Successfully Submitted");
        console.log(userDetails); //SAVE ENDPOINT NEEDED HERE
  ...
  if (document.getElementById('registerForm')) {
    ...
    formRegister.addEventListener('click', function (e) {
      ...
      if (validateForm(form)) {
        var registerDetails = formToJSON(registerForm.elements);
        alert("Successfully Submitted");
        console.log(registerDetails); //SAVE ENDPOINT NEEDED HERE FOR REGISTER DETAILS
      }
    });
  }
};
